...
class TimeoutTickerTest extends \PHPUnit_Framework_TestCase {
	...
	public function testWait() {
		...
		$this->assertEquals(self::TEST_PERIOD, ($stop1 - $start) * 1000, '', self::TEST_PERIOD * self::TIMEOUT_PRECISION);
		$this->assertEquals(self::TEST_PERIOD / 2, ($stop2 - $stop1) * 1000, '', self::TEST_PERIOD * self::TIMEOUT_PRECISION / 2);
	}
}
